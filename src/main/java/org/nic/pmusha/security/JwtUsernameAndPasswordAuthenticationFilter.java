...
import org.nic.pmusha.utility.EncryptionDecryptionUtil;
import org.nic.pmusha.utility.HashCreator;
...
//	Hashing256 hashObj;
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			//String email = EncryptionDecryptionUtil.getDecryptedString(creds.getUsername());
			...
			//request.setAttribute("usertype", creds.getUsertype());
...
//			.setExpiration(new Date(now + 120 * 1000))  // in milliseconds
	...
	public void unsuccessfulAuthentication(HttpServletRequest request,
		...
		//UserMaster user =  userDao.fetchUserByUsername(username);
