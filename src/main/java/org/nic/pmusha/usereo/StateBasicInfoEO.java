...
public class StateBasicInfoEO implements Serializable {
    ...
    @JoinColumn(name = "state_category_id", referencedColumnName = "id", insertable = false, updatable = false)
    private RefStateCategoryEO stateCategory;
    @NotNull
    @NotBlank
    ...
    @JsonIgnore
    @Column(name = "state_profile_document_id")
    private Integer stateProfileDocumentId;
