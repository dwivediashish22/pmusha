...
public abstract class DateUtils {
	...
	static DateTimeFormatter DATE_TIME_FOMATTER_NEW_SLASH = DateTimeFormatter.ofPattern("dd/MM/yyyy");
	...
	static SimpleDateFormat DATE_FOMATTERSEC_SIMPLE_DATE = new SimpleDateFormat("dd/MM/yyyy");
	 ...
	 * it will return time stamp ,this method should be used to get time stamp from front-end date string
	 */
	public static  LocalDateTime convertStringDateTimeToDBDateTimeNewSlash(String uiDate) {
		return LocalDateTime.parse(uiDate, DATE_TIME_FOMATTER_NEW_SLASH);	
	}
	 ...
	 * it will return string ,this method should be used to get string from db date time stamp
	 */
	public static  String convertDBDateTimeToStringNewSlash(LocalDateTime dbDate) {
		return DATE_TIME_FOMATTER_NEW_SLASH.format(dbDate);
	}


	public static  String convertDBSlashDateToString(Date dbDate) {
		return DATE_FOMATTERSEC_SIMPLE_DATE.format(dbDate);
	}
}
